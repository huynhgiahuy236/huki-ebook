...
BCRYPT_ROUNDS=12
IDENTITY_DATABASE_URL=postgresql://postgres:password@localhost:5432/identity_db?schema=public
...
BUSINESS_DATABASE_URL=postgresql://postgres:password@localhost:5432/business_db?schema=public
...
COMMERCE_DATABASE_URL=postgresql://postgres:password@localhost:5432/commerce_db?schema=public
...
PROMOTION_DATABASE_URL=postgresql://postgres:password@localhost:5432/promotion_db?schema=public
```
