        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-8 border-b border-white/15 text-xs">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-white/80">
              <li><Link href="/" className="hover:text-white transition-colors">Sàn TMĐT Sách</Link></li>
              <li><Link href="/books" className="hover:text-white transition-colors">Khám phá Sách &amp; Combo</Link></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-white/80">
              <li><Link href="/seller/dashboard" className="hover:text-white transition-colors">Bảng điều khiển Seller</Link></li>
              <li><Link href="/seller/orders" className="hover:text-white transition-colors">Quản lý Đơn hàng</Link></li>
              <li><Link href="/seller/products/create" className="hover:text-white transition-colors">Đăng tải Sách Hybrid</Link></li>
              <li><Link href="/seller/products/create/ebook" className="hover:text-white transition-colors">Đăng tải Ebook DRM</Link></li>
              <li><Link href="/seller/register" className="hover:text-white transition-colors">Đăng ký Đối tác NXB</Link></li>
            </ul>
          </div>
