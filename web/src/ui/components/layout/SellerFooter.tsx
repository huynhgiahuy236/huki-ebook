    ...
    <footer className="bg-theme-surface border-t border-theme-border py-6 px-4 md:px-8 text-xs text-theme-text-muted mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <Link href="/seller" className="hover:text-theme-text transition-colors">Quy chế hoạt động</Link>
          <span>•</span>
          <Link href="/seller/register" className="hover:text-theme-text transition-colors">Chính sách bản quyền DRM</Link>
          <span>•</span>
