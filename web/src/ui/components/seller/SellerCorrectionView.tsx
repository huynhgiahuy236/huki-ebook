...
export default function SellerCorrectionView() {
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-theme-border/60 pb-5">
          <div>
            <div className="flex items-center gap-2 text-xs text-on-surface-variant mb-2">
              <Link className="hover:text-primary transition-colors font-semibold" href="/seller/dashboard">Kênh Người Bán</Link>
              <span className="text-theme-border">/</span>
              <Link className="hover:text-primary transition-colors font-semibold" href="/seller/products">Sản Phẩm</Link>
              <span className="text-theme-border">/</span>
