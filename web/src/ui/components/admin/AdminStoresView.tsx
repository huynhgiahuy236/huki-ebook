            ...
            <table className="w-full text-left border-collapse text-xs">
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredStores.map((st) => {
                  const cfg = (STATUS_CONFIG as any)[st.status] || STATUS_CONFIG.PENDING_APPROVAL;
            ...
            <div className="flex-1 overflow-y-auto p-5 flex flex-col gap-5 text-xs">
              ...
              <div className="p-4 rounded-xl bg-gray-50 border border-gray-200 flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold border ${((STATUS_CONFIG as any)[selectedStore.status] || STATUS_CONFIG.PENDING_APPROVAL).badge}`}>
                    {((STATUS_CONFIG as any)[selectedStore.status] || STATUS_CONFIG.PENDING_APPROVAL).label}
                  </span>
                </div>
