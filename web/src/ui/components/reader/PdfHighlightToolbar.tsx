...
export interface PdfHighlightToolbarProps {
  bookId: string;
  pageNum: number;
}

export default function PdfHighlightToolbar({ bookId, pageNum }: PdfHighlightToolbarProps) {
  const {
    isHighlighterActive,
        ...
        <div className="flex items-center gap-1.5">
          {HIGHLIGHT_COLORS.map(c => (
            <button
              ...
              className={`w-5 h-5 rounded-full transition-transform flex items-center justify-center border cursor-pointer ${
      ...
      {hasHighlights && (
        <>
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-1 rounded-md text-red-400 hover:text-white hover:bg-red-500/20 transition-all font-medium text-[11px] cursor-pointer"
