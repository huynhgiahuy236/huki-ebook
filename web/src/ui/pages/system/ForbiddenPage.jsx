...
export default function ForbiddenPage({ 
  title = "Cá mập chưa cho bạn vào!", 
  desc = "Khu vực này chỉ dành cho những thành viên có quyền truy cập phù hợp. Có vẻ bạn đang thiếu chiếc chìa khóa hợp lệ để mở cánh cổng này.",
  backLink,
  backText
}) {
      ...
      <div className="grid h-screen w-full grid-cols-1 lg:grid-cols-12 overflow-hidden">
        ...
        >
          ...
          <div className="relative z-10 shrink-0">
            <div>
              <Link to="/" className="inline-flex items-center gap-3 group">
                <div className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-md flex items-center justify-center text-white border border-white/20 group-hover:scale-105 transition-transform shadow-inner">
                  <span className="material-symbols-outlined text-2xl text-rose-300">security</span>
                </div>
                <div>
                  <span className="font-editorial text-2xl font-bold tracking-tight text-white block leading-none">
                    HUKI EBOOK
                  </span>
                  <span className="text-[10px] uppercase tracking-widest text-rose-300 font-bold mt-0.5 block">
                    Khu Vực Giới Hạn Quyền
                  </span>
                </div>
              </Link>
            </div>
            ...
            <div className="mt-3">
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/15 text-rose-200 text-xs font-semibold backdrop-blur-sm shadow-2xs">
                <span className="w-1.5 h-1.5 rounded-full bg-rose-500 animate-pulse" />
                <span>Bảo mật sàn · Mã lỗi #ERR-403-SHARK</span>
              </span>
            </div>
          </div>

          {/* Center: Hero Mascot & 403 Badge */}
          <div className="relative z-10 flex flex-col items-center justify-center my-auto py-2">
            ...
            <div className="w-full max-w-[220px] h-28 flex items-center justify-center">
              <svg viewBox="0 0 240 140" className="w-full h-full drop-shadow-md" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M25 140 Q30 100 20 70 T30 30" stroke="#10B981" strokeWidth="3" strokeLinecap="round" opacity="0.5" />
                <path d="M215 140 Q210 105 220 75 T212 40" stroke="#10B981" strokeWidth="3" strokeLinecap="round" opacity="0.5" />

                <path d="M15 105 L225 105" stroke="#475569" strokeWidth="3" strokeLinecap="round" strokeDasharray="6 4" />

                <g transform="translate(55, 85)">
                  <rect x="0" y="8" width="36" height="24" rx="3" fill="#D97706" stroke="#92400E" strokeWidth="2" />
                  <path d="M0 8 Q18 -2 36 8 Z" fill="#F59E0B" stroke="#92400E" strokeWidth="2" />
                  <rect x="13" y="12" width="10" height="12" rx="2" fill="#FEF3C7" stroke="#92400E" strokeWidth="1.5" />
                  <circle cx="18" cy="16" r="1.5" fill="#92400E" />
                  <line x1="18" y1="17.5" x2="18" y2="21" stroke="#92400E" strokeWidth="1.5" />
                </g>
                ...
                <g transform="translate(95, 26)">
                  ...
                  <g transform="translate(66, 42) rotate(15)">
                    <circle cx="0" cy="0" r="4" fill="#F59E0B" stroke="#B45309" strokeWidth="1.5" />
                    <circle cx="0" cy="0" r="2" fill="#FFFFFF" />
                    <rect x="3" y="-1.5" width="12" height="3" fill="#F59E0B" stroke="#B45309" strokeWidth="1.5" />
                    <rect x="11" y="1.5" width="2.5" height="3" fill="#F59E0B" />
                  </g>

                  <circle cx="68" cy="28" r="7" fill="#FFFFFF" />
                  <circle cx="70" cy="28" r="4.5" fill="#0F172A" />
                  <circle cx="69" cy="26" r="1.5" fill="#FFFFFF" />
                  <path d="M62 20 Q70 23 76 21" stroke="#0369A1" strokeWidth="2.5" strokeLinecap="round" />
                  <ellipse cx="60" cy="38" rx="4" ry="2.5" fill="#FDA4AF" />
                  <path d="M64 42 Q72 45 78 38" stroke="#0F172A" strokeWidth="2.5" fill="none" strokeLinecap="round" />
                </g>

                <circle cx="190" cy="45" r="7" fill="#EF4444" className="animate-pulse" />
                <path d="M190 41 L190 46 M190 48 L190 49" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" />
              </svg>
            </div>

            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 border border-white/15 text-xs text-rose-300 mt-2">
              <span className="material-symbols-outlined text-xs">lock</span>
              <span>Quyền truy cập: Bị khóa</span>
            </div>
          </div>
          ...
          <div className="relative z-10 pt-3 border-t border-white/15 shrink-0">
            <div className="flex items-center justify-between text-xs text-white/70">
              <span className="flex items-center gap-2">
                ...
                <span>Phân quyền Role-based RBAC</span>
              </span>
              <span className="font-semibold text-white/90">HUKI Guard Active</span>
            </div>
          </div>
        </section>

        {/* RIGHT COLUMN: Interactive Content, Actions & Navigation */}
        <section className="h-full flex flex-col justify-between bg-white dark:bg-slate-900 p-6 sm:p-8 xl:p-12 lg:col-span-7 overflow-y-auto lg:overflow-hidden">
          ...
          <div className="flex items-center justify-between shrink-0">
            ...
            <span className="text-[10px] font-bold uppercase tracking-wider text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/50 border border-rose-200 dark:border-rose-900 px-2.5 py-0.5 rounded-full">
          ...
          <div className="my-auto py-2 max-w-lg">
            ...
            {/* Mobile Mascot Badge */}
            <div className="lg:hidden mb-3 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-900 text-xs font-semibold text-rose-700 dark:text-rose-300">
              <span className="w-2 h-2 rounded-full bg-rose-500 animate-pulse" />
              <span>403 · Cá mập khóa cổng</span>
            </div>
            ...
            <form onSubmit={handleSearch} className="w-full relative mt-4">
              <div className="relative flex items-center bg-slate-50 dark:bg-slate-800/90 rounded-full border border-slate-200 dark:border-slate-700 shadow-2xs p-1 focus-within:ring-2 focus-within:ring-emerald-600 focus-within:bg-white transition-all">
                ...
                <input
                  ...
                  placeholder="Tìm sách, tác giả hoặc ISBN công khai..."
          ...
          <div className="pt-3 border-t border-slate-100 dark:border-slate-800 space-y-1.5 shrink-0">
            <div className="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">
              HOẶC KHÁM PHÁ KHU VỰC CÔNG KHAI:
            </div>
