            ...
            <div className="mt-6 pt-4 border-t border-[#e8e5df]">
              ...
              <div className="grid grid-cols-3 gap-2.5">
                <button
                  ...
                  disabled
                  aria-disabled="true"
                  title="Tạm khóa — đăng ký mạng xã hội ngoài happy case hiện tại"
                  className="flex items-center justify-center gap-2 py-2 px-3 rounded-xl border border-[#e8e5df] text-xs font-semibold text-[#6b7280] opacity-40 cursor-not-allowed"
                >
