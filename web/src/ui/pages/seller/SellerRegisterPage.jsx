...
export default function SellerRegisterPage() {
  ...
  const [taxVerifiedSource, setTaxVerifiedSource] = useState('');

  // Form State cho 5 Collections (Khởi tạo rỗng để người dùng tự nhập các trường nghiệp vụ riêng)
  const [formData, setFormData] = useState({
    // 1. Collection: businesses (Pháp lý doanh nghiệp - Được tự động điền khi tra cứu MST)
    businessType: 'LLC', // 'CORPORATION' | 'LLC' | 'INDIVIDUAL' | 'PARTNERSHIP'
    company_name: '',
    international_name: '',
    short_name: '',
    tax_code: '',
    ...
    // 2. Collection: business_representatives (Người đại diện & Quản lý - Người dùng tự nhập)
    rep_full_name: '',
    ...
    // 3. Collection: business_bank_accounts (Tài chính & Đối soát - Người dùng tự nhập STK & Ngân hàng)
    account_holder_name: '',
    account_number: '',
    bank_name: '',
    bank_branch: '',
    ...
    // 4. Collection: business_warehouses (Vận hành kho hàng - Người dùng tự nhập địa chỉ kho)
    warehouse_street: '',
    warehouse_ward: '',
    warehouse_district: '',
    warehouse_province: '',
    ...
    // 5. Collection: business_compliance_docs (Giấy phép ngành nghề & DRM)
  ...
  const handleChange = (field, value) => {
    setFormData((prev) => {
      ...
      // Nếu đổi tên công ty, tự động cập nhật tên chủ tài khoản ngân hàng để đảm bảo tính pháp lý
  ...
  const handleLookupTaxCode = async (codeToLookup) => {
    ...
    if (res.success && res.data) {
      const data = res.data;
      // Chỉ tự động điền các thông tin pháp nhân tra cứu được từ CSDL Thuế
      // Các trường nghiệp vụ cá nhân/kho/ngân hàng để người dùng tự nhập
      setFormData((prev) => ({
        ...prev,
  ...
  const handleSubmit = async (e) => {
    ...
    // Lưu trữ hồ sơ chi tiết vào Storage
    try {
    ...
    <main id="main-content" tabIndex="-1" className="min-h-screen bg-slate-50 text-slate-900 py-8 antialiased">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8">
          {/* ========================================================================= */}
          {/* BƯỚC 1: COLLECTION businesses (Pháp lý doanh nghiệp & Tra cứu MST) */}
          {/* ========================================================================= */}
          {currentStep === 1 && (
                ...
                {isTaxVerified && (
                  <div className="p-4 sm:p-5 bg-emerald-50/70 border border-emerald-200 rounded-xl space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 text-xs">
                      ...
                      <div>
                        <span className="text-slate-500 font-medium">Tên tiếng Anh (Quốc tế):</span>{' '}
                      ...
                      <div>
                        <span className="text-slate-500 font-medium">Ngày cấp / Ngày hoạt động:</span>{' '}
                        <span className="text-slate-800 font-mono">{formData.issue_date || '—'}</span>
                      </div>
                      <div>
                        <span className="text-slate-500 font-medium">Cơ quan quản lý thuế:</span>{' '}
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (file) {
                              ...
                              showToast({ title: 'Đã tải lên tệp', message: file.name, type: 'success' });
                            }
                          }}
                        />
                      </label>
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          showToast({ title: 'Đã chọn tệp mẫu', message: 'Giấy_Phep_DKKD_Sample_2026.pdf', type: 'info' });
                        }}
          ...
          {/* ========================================================================= */}
          {/* BƯỚC 2: COLLECTION business_representatives (Người đại diện & e-KYC) */}
          {/* ========================================================================= */}
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="border-b border-slate-100 pb-4">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (file) {
                              ...
                              showToast({ title: 'Đã tải lên ảnh', message: 'Mặt trước CCCD', type: 'success' });
                            }
                          }}
                        />
                      </label>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (file) {
                              ...
                              showToast({ title: 'Đã tải lên ảnh', message: 'Mặt sau CCCD', type: 'success' });
                            }
                          }}
                        />
                      </label>
          ...
          {/* ========================================================================= */}
          {/* BƯỚC 3: COLLECTION business_bank_accounts (Tài chính & Thanh toán AML) */}
          {/* ========================================================================= */}
          {currentStep === 3 && (
            <div className="space-y-6">
              <div className="border-b border-slate-100 pb-4">
          ...
          {/* ========================================================================= */}
          {/* BƯỚC 4: COLLECTION business_warehouses (Vận hành kho hàng) */}
          {/* ========================================================================= */}
          {currentStep === 4 && (
            <div className="space-y-6">
              <div className="border-b border-slate-100 pb-4">
          ...
          {/* ========================================================================= */}
          {/* BƯỚC 5: COLLECTION business_compliance_docs (Giấy phép & DRM) */}
          {/* ========================================================================= */}
          {currentStep === 5 && (
            <div className="space-y-6">
              <div className="border-b border-slate-100 pb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* Upload Giấy phép Xuất bản / Ủy quyền thương hiệu */}
                <div className="md:col-span-2 pt-2">
                  <label className="block text-xs font-semibold text-slate-700 mb-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          showToast({ title: 'Đã chọn tệp mẫu', message: 'Giay_Phep_Xuat_Ban_Sample_2026.pdf', type: 'info' });
                        }}
                        className="h-9 px-2.5 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-lg text-xs font-medium cursor-pointer"
                      >
                        File mẫu
              ...
              <div className="p-4 bg-[#003b2b]/5 border border-[#003b2b]/20 rounded-xl space-y-3">
                <div className="flex items-start gap-3">
                  <input
                    ...
                    className="mt-1 w-4 h-4 rounded text-[#003b2b] focus:ring-[#003b2b] border-slate-300"
                  />
