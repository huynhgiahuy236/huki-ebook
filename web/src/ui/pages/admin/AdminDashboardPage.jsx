  ...
  return (
    <div className="flex flex-col gap-4 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <Link
          to="/admin/businesses"
          className="p-3.5 sm:p-4 rounded-xl bg-white border border-gray-200 hover:border-amber-300 hover:shadow-sm transition-all flex flex-col justify-between group"
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold uppercase tracking-wider text-gray-500">Chờ Phê Duyệt</span>
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${stats.pendingBusinesses > 0 ? 'bg-amber-100 text-amber-800' : 'bg-gray-100 text-gray-600'}`}>
        ...
        <Link
          to="/admin/businesses"
          className="p-3.5 sm:p-4 rounded-xl bg-white border border-gray-200 hover:border-emerald-300 hover:shadow-sm transition-all flex flex-col justify-between group"
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold uppercase tracking-wider text-gray-500">Đối Tác Phát Hành</span>
        ...
        <Link
          to="/admin/books"
          className="p-3.5 sm:p-4 rounded-xl bg-white border border-gray-200 hover:border-indigo-300 hover:shadow-sm transition-all flex flex-col justify-between group"
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold uppercase tracking-wider text-gray-500">Catalog Sách</span>
          ...
          <div className="mt-3">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-[10px] font-semibold text-indigo-700 bg-indigo-50 px-1.5 py-0.2 rounded-full border border-indigo-200">
                Đầu sách
              </span>
            </div>
            <p className="text-[11px] text-gray-500 mt-0.5">
        ...
        <Link
          to="/admin/health"
          className="p-3.5 sm:p-4 rounded-xl bg-white border border-gray-200 hover:border-blue-300 hover:shadow-sm transition-all flex flex-col justify-between group"
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold uppercase tracking-wider text-gray-500">Hạ Tầng Backend</span>
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${stats.healthStatus === 'ok' ? 'bg-emerald-100 text-emerald-800' : 'bg-rose-100 text-rose-800'}`}>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-2xs">
            <div className="flex items-center justify-between pb-3 border-b border-gray-100">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-xs sm:text-sm font-bold text-gray-900">Doanh Nghiệp Chờ Phê Duyệt</h2>
                  <p className="text-[11px] text-gray-500">Hồ sơ đăng ký tài khoản doanh nghiệp mới nhất cần xem xét</p>
                </div>
              </div>
            ...
            {loading ? (
              <div className="py-6 text-center text-xs text-gray-400">Đang tải hồ sơ doanh nghiệp...</div>
                ...
                {pendingBusinesses.map((biz) => (
                  <div key={biz.id} className="py-2.5 flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2.5 min-w-0">
                      <div className="w-8 h-8 rounded-lg bg-gray-100 border border-gray-200 flex items-center justify-center text-gray-700 font-bold text-xs shrink-0">
