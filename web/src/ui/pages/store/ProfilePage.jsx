      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <nav className="flex items-center gap-2 text-xs text-on-surface-variant">
            <Link className="hover:text-theme-primary inline-flex items-center gap-1 font-semibold transition-colors" to="/">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-4 mb-6 border-b border-theme-border text-xs">
          {[
            ...
            { id: 'library', label: 'Tủ Sách Cá Nhân', icon: 'shelves' },
            { id: 'posts', label: 'Bài Viết', icon: 'article', deferred: true },
            { id: 'reviews', label: 'Đánh Giá & Nhận Xét', icon: 'rate_review', deferred: true },
