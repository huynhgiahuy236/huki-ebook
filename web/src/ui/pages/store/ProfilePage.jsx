...
<span className="text-xs font-semibold text-on-surface-variant opacity-50 cursor-not-allowed" aria-disabled="true" title="Tạm khóa — cộng đồng ngoài happy case hiện tại">Cộng đồng · Tạm khóa</span>
</div>
