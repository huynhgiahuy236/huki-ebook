...
export default function HomePage() {
  ...
  const heroSlides = useMemo(
    () => [
      ...
      },
      {
        ...
        overlay:
          "linear-gradient(to right, rgba(14, 38, 50, 0.94) 0%, rgba(14, 38, 50, 0.82) 50%, rgba(14, 38, 50, 0.2) 100%)",
  ...
  // Flash Sale uses the same live Promotion data as /flash-sale.
  const allFlashSale = useMemo(() => {
    return (activeFlashSale?.items || []).map((item) => {
      ...
      return {
        ...
        cover:
          book?.coverUrl || book?.coverImage || "/banners/book-placeholder.jpg",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          <div className="lg:col-span-8 flex flex-col gap-3">
            ...
            <blockquote className="text-[13px] italic text-emerald-200 border-l-2 border-secondary-container pl-3 my-0.5 leading-relaxed">
              "Khi bạn bắt đầu nhìn sâu vào bên trong chính mình, cả thế giới
              hỗn độn bên ngoài bỗng trở nên sáng tỏ và bình yên lạ thường."
            </blockquote>
