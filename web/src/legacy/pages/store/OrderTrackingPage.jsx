      ...
      <div className="bg-theme-surface border border-theme-border p-6 sm:p-8 rounded-3xl shadow-sm mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link
            ...
            aria-disabled="true"
            tabIndex={-1}
            className="pointer-events-none opacity-35 grayscale bg-theme-primary text-white px-4 py-2.5 rounded-xl font-semibold text-xs flex items-center gap-1.5 shadow-xs"
          >
          ...
          <div className="bg-theme-surface border border-theme-border p-6 rounded-3xl shadow-sm space-y-4">
            ...
            <div className="pt-4 space-y-2">
              ...
              <Link
                ...
                aria-disabled="true"
                tabIndex={-1}
                className="pointer-events-none opacity-35 grayscale w-full py-2.5 bg-theme-secondary-subtle text-on-surface font-semibold text-xs rounded-xl flex items-center justify-center gap-1.5"
              >
