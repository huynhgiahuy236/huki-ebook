...
<span className="font-label-sm text-tertiary">COD • Thanh toán khi nhận hàng</span>
</div>
...
<Link aria-disabled="true" tabIndex={-1} className="pointer-events-none opacity-35 grayscale mt-4 font-title-md text-body-sm text-tertiary flex items-center gap-1" to="/community">
