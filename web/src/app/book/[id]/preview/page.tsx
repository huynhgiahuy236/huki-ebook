...
export default function BookPreviewPage() {
  ...
  const themeStyles: Record<'paper' | 'sepia' | 'dark', string> = {
      ...
      <div className="flex-1 max-w-3xl w-full mx-auto px-6 sm:px-12 py-10 lg:py-16">
        ...
        >
          ...
          <div className="my-8 p-6 rounded-2xl bg-black/5 border-l-4 border-[#006953] italic">
            &ldquo;Nếu bạn có thể trở nên tốt hơn 1% mỗi ngày trong một năm, bạn sẽ kết thúc năm đó với kết quả tốt hơn gấp 37 lần so với lúc bắt đầu.&rdquo;
          </div>
