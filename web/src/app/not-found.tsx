...
export default function NotFound() {
  ...
  return (
    <main id="main-content" tabIndex={-1} className="fixed inset-0 z-[9999] h-screen w-screen max-h-screen overflow-hidden bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-100 font-sans antialiased outline-none selection:bg-[#94f5d6]/30">
