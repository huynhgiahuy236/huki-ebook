      ...
      <aside className="w-full lg:w-[260px] bg-theme-surface border-r border-theme-border flex flex-col justify-between z-10 shrink-0 px-4 py-5">
        <div className="flex flex-col h-full">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Link
              href="/library/devices"
              className="flex items-center justify-between px-3 h-[40px] rounded-xl text-on-surface hover:bg-theme-bg font-medium text-xs transition-colors mt-4 border-t border-theme-border pt-3"
            >
              <div className="flex items-center gap-2">
