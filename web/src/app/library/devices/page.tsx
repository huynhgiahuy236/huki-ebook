  ...
  return (
    <div className="w-full max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-20 font-body-md">
      ...
      <nav className="flex items-center gap-2 text-body-sm text-on-surface-variant mb-6 flex-wrap">
        ...
        <span>/</span>
        <Link href="/profile" className="hover:text-primary transition-colors">Cài Đặt Tài Khoản</Link>
        <span>/</span>
        <Link href="/library" className="hover:text-primary transition-colors">Tủ Sách</Link>
        <span>/</span>
