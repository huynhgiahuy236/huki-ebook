        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 print:hidden bg-white p-4 rounded-2xl border border-[#E8E5DF] shadow-xs">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 text-xs text-[#6B7280]">
              <Link href="/orders" className="hover:text-[#003B2B] font-medium transition-colors">Đơn Hàng</Link>
              <span>/</span>
              <Link href={`/orders/${orderId}`} className="hover:text-[#003B2B] font-medium transition-colors">#{orderId}</Link>
            </div>
          </div>
