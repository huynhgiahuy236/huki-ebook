...
export default function ChangePasswordPage() {
  ...
  const validateConfirm = (conf: string, pwd: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.success) {
      ...
      const errorMsg = res.error?.message || (typeof res.error === 'string' ? res.error : 'Mật khẩu hiện tại không chính xác hoặc mật khẩu mới chưa đạt chuẩn.');
