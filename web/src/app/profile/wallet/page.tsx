      ...
      <div
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col sm:flex-row lg:flex-col justify-center gap-3 lg:border-l lg:border-white/10 lg:pl-8">
            <button
              onClick={() => setShowTopupModal(true)}
              className="w-full py-3.5 px-6 bg-amber-500 hover:bg-amber-400 text-stone-900 font-bold rounded-xl transition-all flex items-center justify-center gap-2 shadow-md text-xs sm:text-sm cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full py-3.5 px-6 bg-white/10 hover:bg-white/15 text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-2 border border-white/10 text-xs sm:text-sm cursor-pointer"
            >
          ...
          {topupPackages.map(pkg => (
            ...
            >
              ...
              <button
                ...
                className={`w-full py-3 rounded-xl font-bold text-xs transition-all cursor-pointer ${pkg.popular
            ...
            <div key={item.id} className="bg-theme-surface border border-theme-border rounded-3xl p-5 shadow-xs flex flex-col justify-between space-y-4">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-theme-border">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-theme-primary hover:bg-theme-primary-hover text-white rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer"
                >
                  Đổi Ngay
                </button>
              </div>
          ...
          <div className="flex items-center gap-1.5 bg-theme-surface-subtle p-1 rounded-2xl overflow-x-auto text-xs">
            {[
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl font-medium transition-all cursor-pointer ${activeHistoryTab === tab.id
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-theme-surface rounded-3xl max-w-md w-full p-6 sm:p-8 space-y-6 shadow-2xl border border-theme-border">
            <div className="flex items-center justify-between pb-3 border-b border-theme-border">
              ...
              <button onClick={() => setShowTopupModal(false)} className="p-1 hover:bg-theme-surface-subtle rounded-lg cursor-pointer">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[100000, 300000, 500000, 1000000].map(amt => (
                    <button
                      ...
                      className={`p-3 rounded-2xl border-2 text-xs font-bold transition-all cursor-pointer ${selectedTopupAmount === amt
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex-1 py-3 border border-theme-border rounded-xl text-xs font-semibold text-on-surface cursor-pointer"
              >
                Hủy Bỏ
              </button>
              <button
                onClick={handleExecuteTopup}
                className="flex-1 py-3 bg-theme-primary hover:bg-theme-primary-hover text-white rounded-xl text-xs font-bold shadow-sm cursor-pointer"
              >
                Xác Nhận Nạp Xu
              </button>
            </div>
