  ...
  return (
    <div className="w-full max-w-[1520px] mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-20 font-body-md">
      ...
      <nav className="text-body-sm text-on-surface-variant mb-6 flex items-center gap-2 flex-wrap">
        ...
        <span>/</span>
        <Link href="/community" className="hover:text-[#ac2c19] transition-colors">Mạng Xã Hội Độc Giả</Link>
        <span>/</span>
        <Link href="/community/clubs" className="hover:text-[#ac2c19] transition-colors">CLB Sách</Link>
        <span>/</span>
        <span className="text-theme-primary font-semibold">CLB Tư Duy Tinh Gọn &amp; Khởi Nghiệp (#{id})</span>
      </nav>
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl text-white">
            ...
            <h2 className="font-editorial text-xl sm:text-2xl md:text-3xl font-bold italic leading-snug">
              &ldquo;Chia sẻ tri thức, đồng hành cùng 14.200 độc giả tinh hoa trên hành trình tự học và khai phóng tư duy.&rdquo;
            </h2>
          </div>
        </div>
