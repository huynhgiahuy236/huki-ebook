    ...
    <div className="min-h-screen bg-theme-bg py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-2 text-xs text-[#6b7280] mb-6">
          <Link href="/community" className="hover:text-theme-primary font-medium transition-colors">Diễn Đàn Cộng Đồng</Link>
          <span>/</span>
          <Link href="/community/reviews" className="hover:text-theme-primary font-medium transition-colors">Bài Viết Phân Tích</Link>
          <span>/</span>
