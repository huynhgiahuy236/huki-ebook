      ...
      <div className="bg-surface-container-lowest border-b border-[#E8ECEA] px-8 sticky top-16 z-30 shadow-[0_2px_8px_-2px_rgba(23,32,31,0.03)]">
        <div className="max-w-[1460px] mx-auto flex items-center justify-between py-2.5">
          <nav className="flex items-center gap-1 overflow-x-auto no-scrollbar">
            ...
            <Link href="/community/reviews" className="px-4 py-2 rounded-lg font-body-md text-sm text-on-surface-variant hover:text-huki-emerald hover:bg-slate-100 transition-colors flex items-center gap-1.5">
              <span className="material-symbols-outlined text-[18px]">stars</span>
              Review Sách
            </Link>
            <Link href="/community/quotes" className="px-4 py-2 rounded-lg font-body-md text-sm text-on-surface-variant hover:text-huki-emerald hover:bg-slate-100 transition-colors flex items-center gap-1.5">
              <span className="material-symbols-outlined text-[18px]">format_quote</span>
              Trích Dẫn Hay
            </Link>
            <Link href="/community/clubs" className="px-4 py-2 rounded-lg font-body-md text-sm text-on-surface-variant hover:text-huki-emerald hover:bg-slate-100 transition-colors flex items-center gap-1.5">
              <span className="material-symbols-outlined text-[18px]">diversity_3</span>
              CLB Sách
            </Link>
            <Link href="/community/challenge" className="px-4 py-2 rounded-lg font-body-md text-sm text-on-surface-variant hover:text-huki-emerald hover:bg-slate-100 transition-colors flex items-center gap-1.5">
          ...
          <div className="col-span-12 lg:col-span-3 space-y-5">
            <div className="bg-surface-container-lowest border border-[#E8ECEA] rounded-xl p-5 shadow-[0_4px_20px_-2px_rgba(23,32,31,0.04)]">
              <div className="flex items-center gap-3 mb-4">
                <img className="w-14 h-14 rounded-full object-cover border-2 border-huki-emerald shadow-sm" alt="Minh Tri" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDlnLDlf-8V0KQzVEEJhqGtNz8sRjXNludFbQbMKbLhAqghUXI_uPUp6Nejx5Ppr5OE_oGb6eQxDRMyHJK6h5eicVWXiJ3EQBeh-l-O1DolMqPZFdmnlsHLBF0buZWgTZVqAP6MU_ttRql3xn-BeQ8XNf3QgT9AB1S0QY8QGXiuZ1msap9wbTnqZqeEGXsFHxfZG0yWC45VJUnvgFNoxzVEcpTjDMhKR-Yl0blONfsDR-mNf84mjWdwIw" />
                <div>
            ...
            <div className="bg-surface-container-lowest border border-[#E8ECEA] rounded-xl p-5 shadow-[0_4px_20px_-2px_rgba(23,32,31,0.04)]">
              ...
              <div className="flex items-center justify-between text-[11px] text-slate-500">
                ...
                <Link className="text-huki-emerald hover:underline font-medium" href="/community/challenge">Chi tiết</Link>
              </div>
            </div>
            ...
            <div className="bg-surface-container-lowest border border-[#E8ECEA] rounded-xl p-5 shadow-[0_4px_20px_-2px_rgba(23,32,31,0.04)]">
              ...
              <div className="flex gap-3">
                <div className="w-16 h-24 rounded-md overflow-hidden flex-shrink-0 book-spine-crease shadow-md border border-black/10">
                  <img className="w-full h-full object-cover" alt="The Power of Habit" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA6_kDR5YvqOtnJaD3jplgl4UKkeUecXXjJnRQyFkwxxfSP017uZDGRlzP0jNSkOI8dXEcCitjSNGQ-pmQJgA4Gjt4HNdOLN2jLNwlpMq39AUcbCS2Ieo0twYzs3T8ueXqW42seSfIMRRd-QPmh-I2wV2zkLIC28nFKKYcPSlGhFkQ1MHq-4b9XF8YndegrhAPjLv3VXcJrOlTZtIMxbYiyaXbbka5mYYgjcDyN9JS0MzaluKuBzcoPQQ" />
                </div>
                <div className="flex flex-col justify-between py-0.5 flex-1">
                  ...
                  <div>
                    ...
                    <Link className="inline-flex items-center gap-1 text-[11px] font-title-md font-semibold text-huki-emerald hover:text-huki-emerald-dark" href="/library/1">
            ...
            <div className="bg-surface-container-lowest border border-[#E8ECEA] rounded-xl p-4 shadow-[0_4px_20px_-2px_rgba(23,32,31,0.04)]">
              <div className="space-y-1 text-sm font-body-md text-on-surface">
                <Link className="flex items-center justify-between px-3 py-2 rounded-lg hover:bg-[#F2FBF9] hover:text-huki-emerald transition-colors" href="/library">
                ...
                <Link className="flex items-center justify-between px-3 py-2 rounded-lg hover:bg-[#F2FBF9] hover:text-huki-emerald transition-colors" href="/community/reviews">
                  <span className="flex items-center gap-2.5">
                ...
                <Link className="flex items-center justify-between px-3 py-2 rounded-lg hover:bg-[#F2FBF9] hover:text-huki-emerald transition-colors" href="/community/clubs">
                  <span className="flex items-center gap-2.5">
          ...
          <div className="col-span-12 lg:col-span-6 space-y-6">
            <div className="bg-surface-container-lowest border border-[#E8ECEA] rounded-xl p-4 shadow-[0_4px_20px_-2px_rgba(23,32,31,0.04)]">
              <div className="flex gap-3 mb-3">
                <img className="w-10 h-10 rounded-full object-cover flex-shrink-0" alt="Minh Tri" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCp-28SkresEm2cdwsuk2HGNdqtYh0gx0N1s_SekTzRk1c3WKtx242udUTwnH7FQDwEp-d6EKfQPtbsyj5as7rG8V9_UjQIyRydhCwdFr43cvM8Y1bnWZ7p2-2TVss5AhcTkzAR2d-eRs2e0NlxXrf4tl2wrzsQHIoKhm-KWRS83y27s-iHAlvQ0ZAaKjxlFkT7KrWbXOIfCfdYJNp-caF8EQuhhH-uH5VOJYa1eUjE_Wg3Q_OK6qsUkQ" />
            ...
            <article className="bg-surface-container-lowest border border-[#E8ECEA] rounded-xl p-5 shadow-[0_4px_20px_-2px_rgba(23,32,31,0.04)] space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <img className="w-10 h-10 rounded-full object-cover" alt="Nguyen Minh Anh" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAaX07yNdYdhY2C1-cOynexJ0abrpcHFKyYurVxGkYlL2Scd5lhK9tkuM91SaobV8o8lfJxV96cFxzVXx5dyxK-vQg6-xTGkh15DduVQttX4NSVvA5rQbHudOT-Uu_aH4OtzcEPih86I5V0zeuan37JnGItUBdb294phhQ4eeEfbUcGZcwm0tLthDbvfuaHmRjZXY5zD8aKfVi8nWivVILmOAQgm-hzIudnmFipr-v9dOHe3I1P4BvWvQ" />
                  <div>
                    <div className="flex items-center gap-1.5">
              ...
              <div className="bg-[#FAF9F6] border border-[#E8ECEA] rounded-xl p-3.5 flex items-center justify-between gap-4">
                <div className="flex items-center gap-3.5">
                  <div className="w-14 h-20 rounded overflow-hidden flex-shrink-0 book-spine-crease shadow-sm border border-black/10">
                    <img className="w-full h-full object-cover" alt="The Alchemist" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCl86uXMhw-NHKbolIKVOO_Swxi92v7I5juHCOWN7MBbtX9IzZ-OKHZpxwhFK4AAirpII5r6AnnZZjC_8jZfIX8e4s2IgacqS33TkW5WaPMliTq6XvuQLYmRXTS7BDy1yTlH7_RSG0xQ7r8vSHYIVQ0f0XqE0JT9Qk_AbEzhcwqZwfFL2qygXUUPTWUmxYBBQv7KRWvNDq0XUjjUgsBFq8Pw_DR9CzC7QtU0KwHhZLY_xcFugC5D_9BCg" />
                  </div>
                  <div>
                ...
                <Link href="/book/nha-gia-kim" className="px-3.5 py-1.5 rounded-lg border border-[#006B50] text-[#006B50] hover:bg-[#006B50] hover:text-white text-xs font-title-md font-semibold transition-all">
                  Đọc thử
                </Link>
              </div>
              ...
              <div className="space-y-2.5 pt-2 bg-[#FAF9F6] p-3 rounded-lg border border-slate-100">
                <div className="flex gap-2 text-xs">
                  <img className="w-7 h-7 rounded-full object-cover flex-shrink-0" alt="Mai Linh" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDiVLWYLSdWPS1AfTPhALRyhC94QCy7pi41Nf_ERoUySFcdCvsjJmBzrYwGnK_MlgKB-mGaQ0wqEeZSGc48OgCkvih7p7tFk18tEM93nefAjbFVSofeIsUGPh6hl9LKFMXnZGifKaQXox3EcThYbUGcuI9ioh-LGdSBIPFggofWRiW_7q6TOAgtElrp5ohPvJ3fARrp5hrgcHrONED2oqzK5F989XICYNCzuu5GFd_a9ePQ58JKkimgWg" />
                ...
                <div className="flex gap-2 text-xs">
                  <img className="w-7 h-7 rounded-full object-cover flex-shrink-0" alt="Hoang Nam" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA-guw9JXK-P1_C0bhvcrw6vvyJrU6DVTPH_rbbPTszHG5QkTfDbOdudGOIVfJOn8iihL7kdEUUPJSjrx5IA8YQfIFhaSzLmophBe0X7SOzlNXHZQ0FyHEkR3M48kUX0xEx8m8SiB_SgSLYQduuNCgjtFsKrL60wWaY_D2eM7LMcHvKRWhvbL6--aL3dE6VDWMQtME47raZxSbNA9QeMh7ypIwIdXz4bMktzqsqkqZRnAcICLtL8Q5bwQ" />
                  <div className="bg-white p-2 rounded-lg border border-slate-200/80 flex-1">
                    <div className="flex items-center justify-between">
            ...
            <article className="bg-surface-container-lowest border border-[#E8ECEA] rounded-xl p-5 shadow-[0_4px_20px_-2px_rgba(23,32,31,0.04)] space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <img className="w-10 h-10 rounded-full object-cover" alt="Le Thao My" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCqP8wtVLtXm2jei8pUngkB6qYjnd00CuahKKcyHJI5Ni__JxXw4RMnZ6IUYgG1cNrZugLHVCUL0p15FepgI_-8wi5IPnZXHfQt0C4NdIJjhYc5khWqFhuJ-hEzeAat1YQbYgMnOS-CJiCHV9zj8Pc71-BbJYBr_2lcdpRK0xkq6w8Fh9CfOMIWmQ4Dc8PO634P8WIeaq8onPWV7Dy3ecpngbsyjmvMDkRUCamIZa73VSFhr3khRFrsmg" />
                  <div>
              ...
              <div className="flex items-center gap-3 bg-[#FAF9F6] p-3 rounded-lg border border-[#E8ECEA]">
                <div className="w-12 h-16 rounded overflow-hidden flex-shrink-0 book-spine-crease shadow-sm border border-black/10">
                  <img className="w-full h-full object-cover" alt="Atomic Habits" src="https://lh3.googleusercontent.com/aida-public/AB6AXuALel0qoczpvGcEvLg2Ptoy4TCRp8cxxS-K9vlTPcNYD-EBvgkbyAyB4iqHhcpnozxNYjOs5wp0mIJEdLyuCHdchHh73Mz98iHYg3hvACD-Ev57aT6yNVT8GWDYmageueDzSbylGWeJ1PbLyP5rBBvYubh81QJnTADNPVebvlp2qljmK2ujex8k34z5V-fVD3wk92o-bwwUQ5vHp_y7AgBGx-7FXJNfdkipZYppi8W9QtpaAGnKbDw6iQ" />
                </div>
                <div className="flex-1">
                ...
                <Link href="/book/atomic-habits" className="px-3 py-1 bg-[#006B50] text-white text-xs font-semibold rounded hover:bg-[#004D38] transition-colors">
                  Xem sách
                </Link>
              </div>
            ...
            <article className="bg-surface-container-lowest border border-[#E8ECEA] rounded-xl p-5 shadow-[0_4px_20px_-2px_rgba(23,32,31,0.04)] space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <img alt="Tran Hoang Long" className="w-10 h-10 rounded-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBSz3_TlTXm0VoNI-RC8pCBPWVZqaPff990W8It6mddITB_SE6rwT6xWn--zMQkmAAxNoAbBBVoqfGxNbsupcsQANXYyzBroyA9fjKJUBC6qckCAUBTUQOvbp7bRHLexmY-n8d6dmwDIqJZW6l5nLyfGOEqQNKBNEIZrF8oGYjcm5td8HxWOyfL90j1vzJTvgKha_zLcYHNMDxlh1FzT6A2QvVW5PPByedDSoJsqtkUr0GLsj3tqdbRIQ" />
                  <div>
                    <div className="flex items-center gap-1.5">
          ...
          <div className="col-span-12 lg:col-span-3 space-y-5">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <img alt="Minh Anh" className="w-8 h-8 rounded-full object-cover border border-amber-300" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAqyHhW4LXQfPRM1Ay4dx7XHykIdRWOLx-aHxgF7fPapgMqUdwpyvn_9srxPh3TMPehJ5Cpi-GSUYNaY-nkXf5DOoNQX2HFeajGyHR6GBKBaAqGOh1w8lsTLtRyPRJZd0REgi_V7D35U1LpXioXY5Yz9XVG9tt4mEIf9reAfkhH703QC-jSNuNVIapjMF0pO6wTQPRvtZKEyf4KpFq2gMJ9b2cNA_13Cm6G07Xt6H8eAZWooNvGDsrW3w" />
                    <div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <img alt="Gia Huy" className="w-8 h-8 rounded-full object-cover border border-slate-300" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD5jNYeY5Lh5zt4nPpIMtylJhiwo766hxi3jgaDq9RwOkaYt23OrKHZ_41DVHzBkboxZ6Sb0dtKNBVoumnbDE7Aa8-iJ99lz3KHOFB02Guar7HBafaTOBqV7Cl9lzuA1owG_oHoffzsAn_Xe_IjEc7oOdt-J9Ktl_ljXmElGBKZou9G55KtvcvQHPYGzhesKyHPkLr4H6sckJMuc1ReSSJ-gMZFtuVhdLYHUlLpLLb_pUuwyGZmDLTuJw" />
                    <div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <img alt="Duc Kien" className="w-8 h-8 rounded-full object-cover border border-amber-700/30" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBF2oGpupLJaYRbeDnbFxeSf182zLMETdMdDIj4myEQr0Vr3Ogv-ivrBnDGflVZWb-OjuiD1VX5X-PVWwNKHxTUTpInuotxlBCerzs4-BKhbxUmLZWEdoBY5xC_NuOFMJEuEaXMzK0FXrnrMVOYaIqsW7ShHUVc_5Twk6DDfdg8S7pdrO9t9fzEdxIvhn_jJHeZZs15R2qTdUNV-aJWllG8hLRc7AlOOSEilRuc8bT9k25lR0YRXJiytg" />
                    <div>
                ...
                <div className="flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2.5">
                    ...
                    <img alt="Hoang Nam" className="w-8 h-8 rounded-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBSs4kvZwAfyi5GR5Yungn1PHt7yg9F0_Ft0uqtm7jDSK50jSR67IN63n0vEvPLRuOAGzqMpjDgkE-I63RQSuHwx9QKZS2E26GMzfqc0KereAKrlXWScuKbderyiFGOqBFjuZwPcgSas-ddtkvrxTG7KiTVOuWHGkeyb0j25RqsBwnO6o0gkQUl6w3qfRR8HPJMSfegAx5wts3iXs-MPP_rAbWJPIBD40EJ9OWR32JOq7aRgfL9k8ldlw" />
            ...
            <div className="bg-surface-container-lowest border border-[#E8ECEA] rounded-xl p-5 shadow-[0_4px_20px_-2px_rgba(23,32,31,0.04)]">
              ...
              <div className="space-y-2.5">
                <Link className="block group" href="/community">
                ...
                <Link className="block group" href="/community/reviews">
                  <div className="flex justify-between items-center text-xs">
                    <span className="font-title-md font-semibold text-on-surface group-hover:text-huki-emerald transition-colors">
                      #ReviewSách
                    </span>
                ...
                <Link className="block group" href="/community/challenge">
                  <div className="flex justify-between items-center text-xs">
                    <span className="font-title-md font-semibold text-on-surface group-hover:text-huki-emerald transition-colors">
                      #ThửTháchĐọc2026
                    </span>
            ...
            <div className="bg-surface-container-lowest border border-[#E8ECEA] rounded-xl p-4 shadow-[0_4px_20px_-2px_rgba(23,32,31,0.04)]">
              <div className="flex items-center gap-3">
                <div className="w-12 h-16 rounded overflow-hidden flex-shrink-0 book-spine-crease shadow-sm border border-black/10">
                  <img alt="The Psychology of Money" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDbj0BFswyZls0vALc1YthzmuB1SDYAr0z_z_ZKC3eDYQj_GALoNZHyXyXzkivOy4UM8JDxJDH-9H7oEleMzXJIw9fTuveUvSxwPN22aIEhW2Ud-n4OjiAXDe1xHMYRUAK05gsTRh_dRaLZ77Kc-pwOONIYteU3nIN_0Ea7iwPyApMB-vO0IEK--JdSIIo3uZF93A2RczazCAPy-exJbv6yCl0mK7KDoe27sd6-xnR3X_NP_GORVH_ujw" />
                </div>
                <div>
