DO $$ BEGIN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'CartItemFormat') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'PaymentStatus') THEN
        CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'PROCESSING', 'SUCCEEDED', 'FAILED', 'EXPIRED', 'CANCELLED', 'REFUND_PENDING', 'REFUNDED', 'PARTIAL_REFUND', 'REFUND_FAILED');
    END IF;
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'SellerOrderStatus') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'AccessStatus') THEN
...
-- CreateIndex
CREATE UNIQUE INDEX "categories_parent_id_normalized_name_key" ON "categories"("parent_id", "normalized_name");

-- CreateIndex
CREATE UNIQUE INDEX "authors_normalized_name_key" ON "authors"("normalized_name");

-- CreateIndex
CREATE UNIQUE INDEX "authors_slug_key" ON "authors"("slug");

-- CreateIndex
CREATE UNIQUE INDEX "publishers_normalized_name_key" ON "publishers"("normalized_name");
...
-- CreateIndex
CREATE UNIQUE INDEX "payments_provider_payos_order_id_key" ON "payments"("provider", "payos_order_id");
